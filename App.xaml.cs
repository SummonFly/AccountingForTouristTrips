...
namespace AccountingForTouristTrips
{
    ...
    public partial class App : Application
    {
        ...
        private void Seed(AccountingForTouristTrips.TouristTripsModel context)
        {
            ...
            context.Roles.AddOrUpdate(new Model.Role() { Id = 1, Name = "Администратор" });
            context.Roles.AddOrUpdate(new Model.Role() { Id = 2, Name = "Бухгалтер" });
            context.Roles.AddOrUpdate(new Model.Role() { Id = 3, Name = "Менеджер" });
            context.Roles.AddOrUpdate(new Model.Role() { Id = 4, Name = "Клиент" });

            context.Countries.AddOrUpdate(new Model.Country() { Id = 1, Name = "Казахстан" });
            context.Countries.AddOrUpdate(new Model.Country() { Id = 2, Name = "Россия" });
            context.Countries.AddOrUpdate(new Model.Country() { Id = 3, Name = "Кыргызстан" });
            context.Countries.AddOrUpdate(new Model.Country() { Id = 4, Name = "Узбекистан" });
            context.Countries.AddOrUpdate(new Model.Country() { Id = 5, Name = "Таджикистан" });
            context.Countries.AddOrUpdate(new Model.Country() { Id = 6, Name = "Беларусь" });
            context.Countries.AddOrUpdate(new Model.Country() { Id = 7, Name = "Украина" });
            context.Countries.AddOrUpdate(new Model.Country() { Id = 8, Name = "Грузия" });

            context.Clients.AddOrUpdate(new Model.Client()
            {
                Id = 1,
                FirstName = "Иван",
                LastName = "Иванов",
            ...
            context.Tours.AddOrUpdate(new Model.Tour()
            {
                Id = 1,
                Name = "Тур в Алмату",
                CountryId = 1,
            ...
            context.Bookings.AddOrUpdate(new Model.Booking()
            {
                Id = 1,
                TourId = 1,
                ClientId = 1,
            ...
            context.Users.AddOrUpdate(new User()
            {
                ClientId = 1,
                Login = "admin",
                PasswordHash = AuthorizationWindow.HashPassword("admin"),
                RoleId = 1
            });
            context.Users.AddOrUpdate(new User()
            {
